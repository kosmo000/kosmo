...
public class Using_Method07 {
	...
	//static void print(int c) {
		// 매개변수의 타입과 갯수가 같아서 오류 발생 : 시그니처가 같다 : 메소드명, 매개변수의 타입, 갯수
	//}
	...
	/*	위의 메소드와 시그니처가 동일 함 : 메소드명, 입력매개변수 타입, 갯수
	...
	*/
	...
	public static void main(String[] args) {
		...
		//	: 동일한 메소드 이름에 대해서 시그니처가 다른 경우 다른 메소드로 인식 한다.
		//		시그니처(식별자) :메소드명 입력매개변수 타입, 입력매개변수 갯수
