...
//		- 메소드 오버라이딩을 사용해서 부모 클래스의 메소드를 재정의 해서 자식 글래스에서 재사용한다.
//
...
//상속을 사용한 다형적 표현
	...
	// - 다시 자식 클래스의 필드와 메소드를 사용 할려면 다운캐스팅을 해야 사용 가능
	// - 다운 캐스팅은 수동으로 적용됨.
...
public class Using_Poltmorphism01 {
	...
	public static void main(String[] args) {
		...
		A a3 = new C();		//C 클래스는 A 타입이다. , C는 A이다 (0)
			//a4는 A, B, C, D 타입을 내포 하고 있고, A타입으로 지정
