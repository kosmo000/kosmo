...
public class Using_Polymorphism02 {
	...
	public static void main(String[] args) {
		...
		//2. Tiger 객체를 Tiger 타입으로 생성
			//t1은 Animal, Tiger를 내포 하고 있고, Tiger 타입으로 지정
		...
		//4. Dog 객체를 Dog 타입으로 생성
			//d1은 Animal, Dog 를 내포 하고 있고, Dog 타입으로 지정
		...
		//6. Dog_sub 객체를 Dog_sub 타입으로 지정
			//ds1는 Animal, Dog, Dog_sub 타입을 내포하고 있고, Dog_sub 타입으로 지정
