...
public class Using_Array_2D {
	public static void main(String[] args) {
		...
		System.out.println(arr1[1].length); //2		<== 0행의 열의 갯수
		System.out.println(arr1[2].length); //3		<== 0행의 열의 갯수
		System.out.println(arr1[3].length); //2		<== 0행의 열의 갯수
		//2. for 문을 사용해서 출력
		...
		for (int i = 0; i <arr1.length; i++) {			// 4번 투표
