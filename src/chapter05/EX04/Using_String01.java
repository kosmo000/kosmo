...
public class Using_String01 {
	...
	public static void main(String[] args) {
		// String : 창조 데이터 타입 , 문자열 처리, 아주 기능들이 많이 들어가 있다.
		
		//1. 객체 생성을 사용 해서 값을 할당. ( 객체의 주소는 별개로 작동)
		String str1 = new String("안녕");
						//new Heap 메모리에 값을 할당
						//String() : 생성자의 매개 변수에 "안녕"
		...
		System.out.println(str2 == str22); 	//str2 와 str22는 동일한 번지를 가르킨다.
