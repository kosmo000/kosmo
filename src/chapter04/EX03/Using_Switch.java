...
public class Using_Switch {
	...
	public static void main(String[] args) {
		//switch 문 - 반드시 break;를 사용 해서 해당 case 탈출
		
		// switch 구문에서 break;를 사용하지 않은 경우
		// 해당 case로 점프후에 하위의 모든case를 실행
		...
		if (c > 9) {
			...
			System.out.println("C 학점");		//실행후 if문을 빠져나온다
		}else {
			System.out.println("D 학점");
		}
